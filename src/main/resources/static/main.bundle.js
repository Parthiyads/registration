...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.resetpassword = function (pwd) {
...
var OtpAuthenticationComponent = /** @class */ (function () {
    function OtpAuthenticationComponent(data, router) {
        this.data = data;
        this.router = router;
    }
    ...
    OtpAuthenticationComponent.prototype.resetPswd = function () {
        ...
        if (this.pwdValNew == this.pwdValCnf) {
            this.data.resetpassword(this.pwdValNew).subscribe(function (data) {
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(_demoService, router) {
        ...
        this.model = { "companyName": "", "ownerName": "", "mobile": "", "password": "", "email": "", "businessAddress": "", "city": "", "state": "", "country": "", "website": "", "category": "", "reg": "" };
        this.submitted = false;
        this.showAddr = false;
    ...
    SignupComponent.prototype.sendOtp = function (mobileNum) {
        ...
        this._demoService.sendOtp(mobileNum).subscribe(function (data) {
            _this._demoService.changeMessage(mobileNum + 'Regi');
        }, function (error) {
        });
    };
